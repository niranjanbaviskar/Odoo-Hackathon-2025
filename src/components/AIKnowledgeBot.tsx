  ...
  useEffect(() => {
    ...
    if (isOpen && messages.length === 0) {
      const welcomeMessage: ChatMessage = {
        ...
        content: "Hi! 👋 I'm your AI learning assistant, powered by SkillSwap's comprehensive knowledge base using advanced vector search technology. I can provide intelligent, contextual answers about courses, quizzes, PDFs, roadmaps, and learning strategies. How can I help you learn today?",
        isBot: true,
        timestamp: new Date(),
        confidence: 'high',
      };
          ...
          <div className="p-4 border-t bg-gray-50 dark:bg-zinc-900 border-gray-200 dark:border-zinc-700 rounded-b-lg">
            ...
            <div className="flex justify-between items-center mt-2">
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Powered by SkillSwap Knowledge Base
              </p>
